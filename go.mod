module git.solusiteknologi.co.id/sts-satusehat/ssbackend

go 1.21

require (
	git.solusiteknologi.co.id/goleaf/glauth v0.0.0-20250211073520-f02bc466a2b1
...
require (
	...
	github.com/mattn/go-nulltype v0.0.0-20230117041332-6715e831ac05 // indirect
...
// replace git.solusiteknologi.co.id/goleaf/glcommon => ../../kbd/glcommon
